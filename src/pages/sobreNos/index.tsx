    ...
    <section className="relative w-full bg-[#A86B1D] overflow-hidden">
      ...
      <div className="max-w-300 mx-auto py-16 md:py-24 lg:py-32">
        <div className="flex flex-col md:flex-row items-center md:items-stretch gap-16">
          ...
          <div className="flex-1 flex items-center md:items-center justify-center md:justify-start">
            <div className="text-white leading-none">
              <span className="block text-8xl md:text-9xl text-center font-theseasons font-medium tracking-tight">
                Business
              </span>
              <span className="block text-[84px] md:text-[160px] lg:text-[180px] text-center font-cocomat font-extrabold tracking-tight leading-[0.8]">
                CORP.
              </span>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center items-center text-[#f7eaad]">
            <div className="flex items-center gap-4 mb-6">
              <h2 className="text-4xl md:text-5xl lg:text-6xl text-center font-cocomat font-semibold tracking-tight">
                Quem somos ?
              </h2>
              <div className="relative flex items-center justify-center w-28 h-28 md:w-32 md:h-32 overflow-hidden">
                <img
                  src={iconBulbMessage}
            ...
            <p className="text-[#f1d1a2] max-w-140 font-garet font-medium text-sm md:text-base lg:text-lg leading-7 md:leading-8 lg:leading-9 text-justify">

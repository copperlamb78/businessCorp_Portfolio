    ...
    <div className="rounded-[28px] w-full max-w-107 xl:max-w-none flex-1 border-[3px] border-[#f8f3ea] bg-[#563512] flex flex-col font-montserrat shadow-2xl relative overflow-hidden h-full transform transition-transform duration-300 xl:scale-[1.07] xl:origin-bottom z-10">
      ...
      <div className="bg-[#f8f3ea] py-2 px-3 flex items-center justify-center gap-2">
        ...
        <Rocket
          color="#563512"
          weight="bold"
          className="drop-shadow-[0_2px_2px_rgba(0,0,0,0.3)] w-10 h-10 lg:w-7 shrink-0"
        />
      </div>

      {/* BODY */}
      <div className="p-3 px-5 flex flex-col gap-2 relative z-10 grow">
        <p className="text-white text-center font-bold text-[12px] sm:text-[13px] leading-tight min-h-8 px-1">
          A jornada completa para transformar a gestão do seu negócio e acelerar
          seus resultados.
        </p>
        ...
        {/* INCLUSO BOX */}
        <div className="border-2 border-[#f8f3ea] rounded-xl p-2 pb-2 bg-transparent relative mt-0">
          <h3 className="text-[#f8f3ea] font-black italic text-[15px] mb-1 -mt-0.5">
            INCLUSO:
          </h3>
        ...
        {/* ENCONTROS SECTION */}
        <div className="border-2 border-[#f8f3ea] rounded-xl p-2 flex items-start gap-2 mt-0">
          <div className="border-2 border-[#563512] rounded-full p-1.5 shrink-0 bg-[#f8f3ea] mt-0 shadow-md">
            <UsersThree size={28} weight="fill" color="#563512" />
          </div>
          <div className="flex flex-col gap-px">
            <h4 className="text-[#f8f3ea] font-black text-[13px] sm:text-[14px] mb-0.5">
              ENCONTROS (MENSAIS)
            </h4>
            <p className="text-white font-bold text-[9px] sm:text-[10px] leading-tight mb-0">
              4 Encontros estratégicos por mês
            </p>
            <p className="text-white font-bold text-[9px] sm:text-[10px] leading-tight mb-0">
              Diagnóstico
            </p>
      ...
      <div className="p-3 pt-0 mt-auto relative pb-6">
        <div className="border-2 border-[#f8f3ea] rounded-[14px] bg-transparent overflow-visible flex flex-col relative">
          <div className="py-1 border-b-2 border-[#f8f3ea] mx-2">
          ...
          <div className="flex w-full divide-x-2 divide-[#f8f3ea] pb-4">
            <div className="flex-1 flex flex-col items-center p-1 py-2 gap-0">
              ...
              <div className="flex items-center text-[#db9a2f] font-black">
                ...
                <span className="text-[14px] sm:text-[15px] tracking-tighter">
                  R$1071,90
                </span>
              </div>
            </div>
          ...
          <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-[#563512] border-2 border-[#f8f3ea] rounded-full px-4 py-0.5 whitespace-nowrap shadow-lg">
